...
export default function PeopleList() {
    ...
    useEffect(() => {
        axios.get(`https://gs-service.onrender.com/people/`)
            .then((response) => {
    ...
    const onDelete = (id) => {
        axios.delete(`https://gs-service.onrender.com/people/${id}`).then(response => {
                        ...
                        <div className="mt-[30rem] relative p-4 max-w-2xl">
                            <div className="relative bg-white rounded-lg shadow">
                                ...
                                <div className="flex items-center p-4 border-t">
                                    ...
                                    <button className='inline-flex items-center pl-5 py-2 ml-1 text-sm font-medium text-white duration-100 bg-green-500 rounded-md hover:bg-blue-200' onClick={handleClose}>
